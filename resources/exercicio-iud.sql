...
DELETE FROM dependente WHERE fcpf='333445555' AND nome_dependente = 'Alice';
DELETE FROM dependente WHERE fcpf='333445555';

-- 3. Altere o nome do departamento 'Pesquisa' para 'Pesquisa científica'.
UPDATE departamento SET dnome='Pesquisa Cientifica' WHERE dnome='Pesquisa';
